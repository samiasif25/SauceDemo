...
driver=webdriver.Chrome(r"C:\Users\Samiullah\Downloads\chromedriver")
...
driver.find_element_by_id("first-name").send_keys("Sami")
time.sleep(1)

driver.find_element_by_id("last-name").send_keys("Asif")
time.sleep(1)

driver.find_element_by_id("postal-code").send_keys(700059)
time.sleep(1)
